const allbikes = [
    {
        ...
        catalog: 'folding',
        info: 'A compact and comfortable electric folding bike perfect for city commuting.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'city',
        info: 'A stylish urban bike combining functionality with modern design.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'mountain',
        info: 'A rugged and capable enduro bike designed for aggressive trail riding.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'mountain',
        info: 'A versatile carbon mountain bike designed for both trail and enduro riding.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'kids',
        info: "A durable and lightweight kids' bike designed for young riders.",
    ...
    },
    {
        ...
        catalog: 'electric',
        info: 'A stylish electric bike ideal for urban commuting.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'mountain',
        info: 'A high-performance carbon mountain bike built for cross-country racing.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'mountain',
        info: 'A powerful electric mountain bike with a long-range 750Wh battery.',
    ...
    },
    {
        ...
        catalog: 'mountain',
        info: 'A retro-style touring bike designed for long-distance adventure riding.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'electric',
        info: 'A premium electric road bike combining performance with modern technology.',
    ...
    },
    {
        ...
        catalog: 'mountain',
        info: 'An agile and responsive hardtail mountain bike built for speed.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'city',
        info: 'A sleek city bike ideal for daily commuting and urban exploration.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'city',
        info: 'A versatile city bike designed for comfort and performance on paved roads.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'folding',
        info: 'A stylish and compact electric bike perfect for urban commuting.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'electric',
        info: 'A versatile electric touring bike designed for long-distance rides.',
    ...
    },
    {
        ...
        catalog: 'mountain',
        info: 'An affordable entry-level mountain bike for beginners.',
    ...
    },
    {
        ...
        catalog: 'kids',
        info: "A versatile kids' bike suitable for park rides and neighborhood adventures.",
        ratinginfo: [
    ...
    },
    {
        ...
        info: 'A high-performance carbon hardtail for demanding cross-country riders.',
        ratinginfo: [
    ...
    },
    {
        ...
        date: 'New!',
        catalog: 'city',
        info: 'A rugged urban bike designed for city commuting and off-road trails.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'city',
        info: 'A robust bike designed for urban commuting with a touch of style.',
    ...
    },
    {
        ...
        catalog: 'kids',
        info: "An entry-level kids' bike designed for younger children.",
        ratinginfo: [
    ...
    },
    {
        ...
        date: 'New!',
        catalog: 'city',
        info: 'An electric city bike that delivers a smooth and effortless ride.',
    ...
    },
    {
        ...
        catalog: 'mountain',
        info: 'A versatile carbon hardtail mountain bike perfect for climbing and descending.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'city',
        info: 'A fitness-focused hybrid bike for road and light off-road use.',
    ...
    },
    {
        ...
        catalog: 'mountain',
        info: 'A premium carbon mountain bike for intense off-road performance.',
        ratinginfo: [
    ...
    },
    {
        ...
        added: false,
        rating: 0,
        info: 'A lightweight and fast cross-country mountain bike.',
        features: [
            'Carbon frame',
    ...
    },
    {
        ...
        catalog: 'mountain',
        info: 'A lightweight and fast carbon hardtail designed for top-level XC racing.',
        ratinginfo: [
    ...
    },
    {
        ...
        catalog: 'mountain',
        info: 'A race-ready carbon mountain bike designed for speed and endurance.',
        ratinginfo: [
    ...
    },
    {
        ...
        "stockInfo": "In stock!",
        "rating": 4,
        "info": "A robust electric bike designed for both commuting and leisure rides.",
        "features": [
...
const mbikes = [
    ...
    },
    {
        ...
        "catalog": "mountain",
        "o_price": 4700,
        "imgl": "./src/assets/images/products/turbo-m.png",
...
const cbikes = [
    ...
    },
    {
        ...
        "catalog": "city",
        "o_price": 0,
        "imgl": "./src/assets/images/products/orbea-carpe-c.png",
        "stockInfo": "In stock!",
...
for (let index = 0; index < allbikes.length; index++) {
    for (let i = 0; i < mbikes.length; i++) {
        allbikes[index].id==mbikes[i].id? allbikes[index]={...allbikes[index],info:mbikes[i].info}:allbikes[index]=allbikes[index]
    }    
    for (let i = 0; i < cbikes.length; i++) {
        allbikes[index].id==cbikes[i].id? allbikes[index]={...allbikes[index],info:cbikes[i].info}:allbikes[index]=allbikes[index]
    } 
    for (let i = 0; i < ebikes.length; i++) {
        allbikes[index].id==ebikes[i].id? allbikes[index]={...allbikes[index],info:ebikes[i].info}:allbikes[index]=allbikes[index]
    } 
    for (let i = 0; i < fbikes.length; i++) {
        allbikes[index].id==fbikes[i].id? allbikes[index]={...allbikes[index],info:fbikes[i].info}:allbikes[index]=allbikes[index]
    } 
    for (let i = 0; i < kbikes.length; i++) {
        allbikes[index].id==kbikes[i].id? allbikes[index]={...allbikes[index],info:kbikes[i].info}:allbikes[index]=allbikes[index]
    } 
}
